"""Off-topic / low-confidence gate (docs/03-harness-and-guardrails.md).
...
invoking the generator — see docs/03-harness-and-guardrails.md.
"""
...
def should_refuse(
    ...
    """Combines both signals per docs/03: either one failing triggers refusal."""
