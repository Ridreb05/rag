"""Shared context-building and citation-marker resolution for the generation
backend, so the [C#]-marker <-> chunk_id mapping logic exists in exactly one
place."""

from __future__ import annotations

from voice_rag.pipeline.generation.schemas import GenerationRequest
