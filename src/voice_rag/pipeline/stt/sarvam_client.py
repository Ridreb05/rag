"""Sarvam STT + TTS REST clients.

Batch/synchronous REST endpoints only (files under 30s) — the streaming
WebSocket API (for partial-transcript speculative retrieval) is a separate,
larger integration and is not implemented here yet. This gives a real,
testable STT/TTS round trip first.
